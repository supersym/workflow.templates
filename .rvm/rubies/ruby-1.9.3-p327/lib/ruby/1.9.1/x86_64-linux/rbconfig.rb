...
module RbConfig
  ...
  CONFIG["MINOR"] = "9"
  CONFIG["TEENY"] = "1"
  CONFIG["PATCHLEVEL"] = "327"
  CONFIG["INSTALL"] = '/usr/bin/install -c'
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/data/solo/ace/users/s/supersym/.rvm/rubies/ruby-1.9.3-p327")
  ...
  CONFIG["configure_args"] = " '--enable-shared' '--disable-install-doc' '--prefix=/data/solo/ace/users/s/supersym/.rvm/rubies/ruby-1.9.3-p327' '--with-opt-dir=/data/solo/ace/users/s/supersym/.rvm/usr'"
  ...
  CONFIG["STATIC"] = ""
  CONFIG["ARCH_FLAG"] = ""
  CONFIG["DLDFLAGS"] = "-L/data/solo/ace/users/s/supersym/.rvm/usr/lib  -Wl,-R/data/solo/ace/users/s/supersym/.rvm/usr/lib "
  CONFIG["ALLOCA"] = ""
  ...
  CONFIG["CXX"] = "g++"
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = " $(DEFS) $(cppflags) -I/data/solo/ace/users/s/supersym/.rvm/usr/include"
  CONFIG["LDFLAGS"] = "-L.  -rdynamic -Wl,-export-dynamic -L/data/solo/ace/users/s/supersym/.rvm/usr/lib  -Wl,-R/data/solo/ace/users/s/supersym/.rvm/usr/lib "
  ...
  CONFIG["RUBY_RELEASE_DATE"] = "2012-11-10"
